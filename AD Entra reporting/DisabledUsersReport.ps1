...
Send-MailMessage -To "user@domain.com", "user2@domain.com", "user3@domain.com" -From "smtpserviceaccount@domain.com" -Subject "Disabled Users" -Body "Disabled Users Report generated by Graph API" -SmtpServer $smtpServer -Port $smtpPort -usessl -Credential $smtpCredential -attachments 'c:\temp\DisabledUsers.csv'
